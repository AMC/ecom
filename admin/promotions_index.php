...
<div id="container">
  ...
  <table style='width: 100%'>
   ...
   <?php $promotions = $db->query("SELECT promotions.id, promotions.name, promotions.start, promotions.end, sum(cart.discount) as savings, sum(cart.subtotal) as sales FROM cart, promotions WHERE cart.discount_code = promotions.promo_code GROUP BY promotions.name ORDER BY end DESC"); ?>    
