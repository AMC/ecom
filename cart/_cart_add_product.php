...
if ($quantity > 0) {
  ...
  if ($matches->num_rows == 0) {
    ...
    $db->query("INSERT INTO cart_products(cart_id, product_id, quantity, price, free_shipping, options) VALUES ('$cart_id', '$product_id', '$quantity', '$price', '$free_shipping', '$options')"); 
