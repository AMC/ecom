...
if (role() != 'admin') {
  ...
  if ($db->query("UPDATE products SET name='$name', quantity='$quantity', manufacturer='$manufacturer', reference='$reference', upc='$upc', category='$category', price='$price', cost='$cost', weight='$weight', discontinued='$discontinued', sold_out='$sold_out', description='$description' WHERE id='$product_id' ")) {
